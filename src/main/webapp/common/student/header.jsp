...
<header id="header" class="header fixed-top d-flex align-items-center">
	...
	<div class="d-flex align-items-center justify-content-between">
		<a href="/student/home" class="logo d-flex align-items-center"> <img
	...
	<nav class="header-nav ms-auto">
		<ul class="d-flex align-items-center">
			...
			<li class="nav-item dropdown pe-3"><a
				...
				data-bs-toggle="dropdown"> <img src="${user.image}"
				...
				<ul
					...
					<li class="dropdown-header">
						<h6>${user.name}</h6> <span>Sinh Viên</span>
					</li>
					<li>
						<hr class="dropdown-divider">
					</li>
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="/student/profile"> <i class="bi bi-person"></i> <span>Thông tin cá nhân</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
					</li>
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="/student/needhelp"> <i class="bi bi-question-circle"></i> <span>Need
								Help?</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
