...
<div id="main">
	<h5>Class : Cloud Computing | GVHD : Huỳnh Xuân Phụng</h5>
	...
	<section id="trainers" class="trainers">
		<div class="container aos-init aos-animate" data-aos="fade-up">
			<div class="row aos-init aos-animate" data-aos="zoom-in"
				...
				<div class="col-lg-4 col-md-6 d-flex align-items-stretch">
					<div class="member">
						<img style="width: 200px; height: 200px; border-radius: 50%;"
							src="/assets/img/20110739.jpg" class="img-fluid" alt="">
						<div class="member-content">
							<br>
							<h4>20110739</h4>
							<span>Nguyễn Hoàng Toàn</span>
							<div class="social">
				...
				<div class="col-lg-4 col-md-6 d-flex align-items-stretch">
					<div class="member">
						<img src="/assets/img/Khang.jpg"
							style="width: 200px; height: 200px; border-radius: 50%;"
							class="img-fluid" alt=""> <br>
						<div class="member-content">
							<br>
							<h4>20110269</h4>
							<span>Nguyễn Thiên Khang</span>
							<div class="social">
								<a href=""><i class="bi bi-twitter"></i></a> <a href=""><i
									class="bi bi-facebook"></i></a> <a href=""><i
									class="bi bi-instagram"></i></a> <a href=""><i
